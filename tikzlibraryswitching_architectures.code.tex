% * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
% 
% Sa-TikZ package v0.3 * * (C) Claudio Fiandrino 2012
% 
% * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
			      ...
			      \ifnum\t=2
			         \ifnum\initmodule=1
			          % if odd
			          	...
			          	\pgfmathtruncatemacro\endmoduleii{int(ceil(\startmodule+1+\applicationon)/2+(\applicationon/2))}
			          	\draw(r\stg-\startmodule-output-1)--(r\nextstg-\endmodulei-input-1);
			          	\draw(r\stg-\startmodule-output-2)--(r\nextstg-\endmoduleii-input-1);
			          \else
			          % if even
			      ...
			      \ifnum\t>2
			         \ifnum\initmodule=1
			          % if odd
			          	...
			          	\pgfmathtruncatemacro\endmoduleii{int(ceil(\startmodule+1+\applicationon)/2+(\applicationon/2)+((\applicationon/2)*(\t-2)))}
			          	\draw(r\stg-\startmodule-output-1)--(r\nextstg-\endmodulei-input-1);
			          	\draw(r\stg-\startmodule-output-2)--(r\nextstg-\endmoduleii-input-1);
			          \else
			          % if even
